...
export function createStudioEnvironment(){
 ...
 const room=new T.Mesh(new T.BoxGeometry(30,18,30),new T.MeshBasicMaterial({color:0x151a1e,side:T.BackSide}));
 scene.add(room);
 ...
 card(14.4,13.8,[-11.8,6.8,4.1],[0,0.42,0],4.7,0xfffcf7);
 // Overhead/front lift so the scene stays bright without flattening the shadows.
 card(11.8,6.4,[-0.8,10.0,1.1],[0,0.32,0],2.95,0xf6f8fb);
 // Soft frontal lift centered slightly to the left.
 card(7.4,5.1,[-1.7,4.8,9.0],[0,0.34,0],1.28,0xf2f5f7);
